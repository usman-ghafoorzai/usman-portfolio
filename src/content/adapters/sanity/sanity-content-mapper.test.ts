...
describe("Sanity runtime boundary", () => {
    ...
    it.each([
        ...
        ["dotted capability document ID", "capabilityAreas.0._id", "capability.workflow"],
        ["dotted capability reference ID", "projects.0.capabilityEvidence.0.capability._id", "capability.workflow"],
